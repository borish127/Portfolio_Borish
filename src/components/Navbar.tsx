  ...
  return (
    <nav className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-2xl">
      <div className="glass-nav rounded-full px-2 py-1.5 md:px-4 md:py-2 flex items-center justify-between gap-1 md:gap-2">
        ...
        >
          EV<span className="text-emerald-500">.</span>
        </a>
          ...
          {navItems.map((item) => {
            ...
            return (
              <a
                ...
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs md:text-sm font-sans-data font-medium transition-all duration-300 ${
                  isActive
